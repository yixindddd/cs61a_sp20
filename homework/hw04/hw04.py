...
def div_interval(x, y):
    ...
    reciprocal of y."""
    "*** YOUR CODE HERE ***"
    assert upper_bound(y) * lower_bound(y) > 0, 'Interval should not span zero'
...
def multiple_references_explanation():
    return """
    I think par2 is a better program for parallel resistances than par1, because the return value of par2 is the correct interval when calculating resistances.
    Par1 is assuming the upper bound and lower bound of r1 can exist at the same time, but it's impossible in the real world.
    """
